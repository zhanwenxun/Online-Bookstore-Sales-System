...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar sidebar-1">
            <ul class="nav nav-sidebar">
                <c:if test="${currentUser.role == 2}">
                    <li class="list-group-item-diy"><a href="#section1">管理工作人员<span class="sr-only">(current)</span></a></li>
                </c:if>
                <li class="list-group-item-diy"><a href="#section2">管理图书</a></li>
                <li class="list-group-item-diy"><a href="#section3">添加图书</a></li>
                <li class="list-group-item-diy"><a href="#section4">管理图书分类</a></li>
                <li class="list-group-item-diy"><a href="#section5">管理留言</a></li>
            </ul>
        </div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <c:if test="${currentUser.role == 2}">
                <div class="col-md-12">
                    <h1><a name="section1">工作人员信息</a></h1>
                    <hr/>
            ...
            <div class="col-md-12">
                <hr/>
                <h1><a name="section3">添加图书</a></h1>
                <hr/>
                <div class="col-sm-offset-2 col-md-offest-2">

                    <div  class="form-horizontal">
                        <div class="form-group">
                            <label for="productName" class="col-sm-2 col-md-2 control-label">图书名称</label>
                            <div class="col-sm-6 col-md-6">
                                <input type="text" class="form-control" id="productName"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="productDescribe" class="col-sm-2 col-md-2 control-label">图书描述</label>
                            <div class="col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="productImgUpload" class="col-sm-2 col-md-2 control-label" accept="image/jpg">图书图片</label>
                            <div class="col-sm-6 col-md-6">
                                <input name="productImgUpload" type="file"  id="productImgUpload"/>
                                <p class="help-block">选择上传图书图片</p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-6">
                                <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="addProduct()">添加图书</button>
                            </div>
                        </div>
                    </div>
                    <br/>
                ...
                <div class="col-md-12">
                    <h1><a name="section4">管理图书分类</a></h1>
                    <hr/>
                    <table class="table table-hover center" id="TypeTable">
                        <tr>
                            <th>图书类型</th>
                            <th>类型名称</th>
                            <th>删除</th>
                        ...
                        <tr>
                            <td>1</td>
                            <td>推荐</td>
                            <td><button class="btn btn-primary delete-button" >删除</button></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>计算机</td>
