        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-md-5 detail-x">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-danger btn-lg col-sm-4 col-md-4 col-lg-4" onclick="addToShoppingCar(${productDetail.id})">添加到购物车</button>
                    <div class="col-sm-2 col-md-2 col-lg-2"></div>
                    <button  class="btn btn-danger btn-lg col-sm-4 col-md-4 col-lg-4" onclick="buyConfirm(${productDetail.id})">直接购买</button>
  ...
  <script type="text/javascript">
      ...
      function addToShoppingCar(productId) {
          ...
          if(addResult == "success") {
              layer.confirm('现在是否前往购物车？', {icon: 1, title:'添加成功',btn:['前往购物车','继续浏览']},
                      function(){
      ...
      function buyConfirm(productId) {
          ...
          html += '<div style="text-align:center; padding-bottom: 3px;"><button class="btn btn-danger col-sm-4 col-md-4 col-lg-4" ' +
              'onclick="addToShoppingRecords('+productId+')">支付成功</button></div>';
      ...
      function listEvaluations() {
          ...
          html= '<div class="col-sm-12 col-md-12 col-lg-12">'+
              ...
              '<div class="col-sm-4 col-md-4 col-lg-4"></div>'+
              '<button class="btn btn-primary btn-lg evaluationButton col-sm-4 col-md-4 col-lg-4" ' +
              'onclick="addToEvaluation()">留言</button>'+
              '</div>';
