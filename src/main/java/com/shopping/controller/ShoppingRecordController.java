...
public class ShoppingRecordController {
    ...
    @RequestMapping(value = "/getShoppingRecordsByPid",method = RequestMethod.POST)
    @ResponseBody
    public Map<String,Object> getShoppingRecordsByPid(int productId){
        List<ShoppingRecord> shoppingRecordList = shoppingRecordService.getShoppingRecords(productId);
        String shoppingRecords = JSONArray.toJSONString(shoppingRecordList);
        Map<String,Object> resultMap = new HashMap<String,Object>();
        resultMap.put("result",shoppingRecords);
        return resultMap;
